...
class FaissSpark:
    ...
    def _partition_fit(
        ...
        bc_index_bytes = session.sparkContext.broadcast(index_bytes)
        del self._index
        self._index = None
        gc.collect()
        ...
        self._sharded_rdd = (
            ...
            .select(*features)
            .rdd
            .mapPartitions(lambda it: FaissSpark._partition_faiss(it, bc_index_bytes))
    ...
    def _partition_faiss(
        ...
        index_bytes = bc_index_bytes.value
